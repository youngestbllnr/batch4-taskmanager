...
class CategoryTest < ActiveSupport::TestCase
  ...
  test "should not save when title is blank" do
    category = Category.new(title: "", description: "This is a sample category.")
    assert_not category.save
  end

  test "should not save when title is not present" do
    category = Category.new(description: "This is a sample category.")
    assert_not category.save
  end

  test "should not save when description is blank" do
    category = Category.new(title: "Sample Category", description: "")
    assert_not category.save
  end
