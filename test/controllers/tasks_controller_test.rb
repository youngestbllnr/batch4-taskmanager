...
class TasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task" do
    assert_difference('Task.count') do
      post tasks_url, params: { task: { category_id: @task.category_id, description: @task.description, due_date: @task.due_date, is_checked: @task.is_checked, title: @task.title } }
    end
